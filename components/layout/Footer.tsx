...
const socialLinks = [
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/coratech-ai/?viewAsMember=true",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/share/161XovqDNKu/?mibextid=wwXIfr",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/coratech.ai?igsh=MW5qMmdkNGg0YWsxMA%3D%3D&utm_source=qr",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@coratech.ai?_r=1&_t=ZS-973MMiB7Axh",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
export function Footer() {
  const cols = [
    ...
    { heading: "Company", links: [["About", "/about"], ["Why Use AI", "/why-ai"], ["Insights", "/insights"], ["Technology", "/technology"], ["Contact", "/contact"]] },
  ];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 pb-12 border-b border-white/10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 mb-6">
              {socialLinks.map(s => (
                <a key={s.name} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.name}
                  className="w-9 h-9 rounded-lg bg-white/08 flex items-center justify-center text-white/50 hover:bg-[#4A6FA5] hover:text-white transition-all duration-200">
                  {s.icon}
                </a>
              ))}
            </div>
            ...
            <div className="mb-4">
              ...
              <a href="https://wa.me/233557265120" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs text-white/40 hover:text-[#25D366] transition-colors mb-1">
