              ...
              <div className="card p-6">
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/233557265120" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-base text-[#0A0F1E] hover:text-[#25D366] transition-colors mb-2">
